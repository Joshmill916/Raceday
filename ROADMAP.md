...
**Phase 1 — Basic card (no payment, no photos).** *In progress.*
...
**Phase 2 — Premium look.** The broadcast-style animated card: driver photo, team
colors, sponsor logos, sweep-in / shine animation. Pure CSS/SVG, no backend. Gated by a
simple `premium` flag on the driver.

**Phase 3 — Payment.** Decide and wire how a driver unlocks premium: offline + admin
